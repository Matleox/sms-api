...
while 1:
    ...
    if menu == 1:
        ...
        if tel_no == "":
            ...
            try:
                ...
                print(Fore.LIGHTRED_EX +
                      "Hatalı dosya dizini. Tekrar deneyiniz.")
                sleep(3)
                continue
        else:
            try:
        ...
        try:
            print(Fore.LIGHTYELLOW_EX +
                  f"Kaç adet SMS göndermek istiyorsun {sonsuz}: " +
                  Fore.LIGHTGREEN_EX,
                  end="")
            kere = input()
            if kere:
...
def is_enough(phone):
    # Bu örnekte her zaman True dönüyor
    # İstersen burada IP limiti veya kontrol koyabilirsin
    return True
